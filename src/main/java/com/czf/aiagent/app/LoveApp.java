package com.czf.aiagent.app;


import com.czf.aiagent.advisor.MyLoggerAdvisor;
import com.czf.aiagent.advisor.ProhibitedWordAdvisor;
import com.czf.aiagent.chatmemory.MybatisPlusChatMemory;
import com.czf.aiagent.rag.QueryRewriter;
...
public class LoveApp {
    ...
    private static final String AGENT_NAME = "LoveAssistant";
...
//    @Resource
    ...
    public LoveApp(DynamicModelService dynamicModelService, MybatisPlusChatMemory mybatisPluschatMemory/* ,MySQLChatMemory jdbcmysqlchatMemory*/) {
//         String fileDir = System.getProperty("user.dir") + "/tmp/chat-memory";
//         ChatMemory chatMemory = new FileBasedChatMemory(fileDir);

//        ChatMemory chatMemory = new InMemoryChatMemory();
//        ChatMemory chatMemory = new MySQLChatMemory(dataSource);
        ChatModel chatModel = dynamicModelService.getChatModelForAgent(AGENT_NAME);
