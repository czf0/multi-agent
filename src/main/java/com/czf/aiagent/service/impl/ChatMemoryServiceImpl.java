...
import com.czf.aiagent.domain.ChatMemory;
import com.czf.aiagent.mapper.ChatMemoryMapper;
import com.czf.aiagent.service.ChatMemoryService;
...
public class ChatMemoryServiceImpl extends ServiceImpl<ChatMemoryMapper, ChatMemory>
    ...
    private Message convertToMessage(ChatMemory entity) {
        MessageType messageType = MessageType.fromValue(entity.getMessageType());
