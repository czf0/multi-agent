package com.licanfu.aiagent.app;


import com.licanfu.aiagent.advisor.ProhibitedWordAdvisor;
...
class LoveAppTest {
    ...
    void testChat() {
        ...
        // 第一轮
        String message = "你好，我是程序员licanfu";
    ...
    void doChatWithReport() {
        String chatId = UUID.randomUUID().toString();
        String message = "你好，我是程序员licanfu，我想让另一半reyan更爱我，但我不知道该怎么做";
    ...
    void doChatWithTools() {
        ...
        //测试内嵌网页html生成
        testMessage("生成一个内嵌网页的 HTML文件，内容是'七夕appointment' 内嵌的页面为 https://mbd.baidu.com/newspage/data/dtlandingsuper?nid=dt_5035641807220252494");

        // 测试联网搜索问题的答案
        testMessage("周末想带女朋友去上海约会，搜索一下推荐几个适合情侣的小众打卡地？");

        // 测试网页抓取：恋爱案例分析
        testMessage("最近和对象吵架了，看看CSDN其他程序员的博客 （https://blog.csdn.net/lishenluo/article/details/109202767） 的其他情侣是怎么解决矛盾的？");
